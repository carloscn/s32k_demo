...
- pin_list:
  ...
  - {pin_num: '39', peripheral: SIUL2, signal: 'gpio, 31', pin_signal: PTA31, direction: OUTPUT, InitValue: state_0}
  - {pin_num: '145', peripheral: LPUART6, signal: lpuart6_rx, pin_signal: PTA15, InitValue: state_0}
  - {pin_num: '143', peripheral: LPUART6, signal: lpuart6_tx, pin_signal: PTA16, direction: OUTPUT, padKeepingEnable: disabled, InitValue: state_0}
