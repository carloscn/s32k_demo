...
#define NUM_OF_CONFIGURED_PINS_PortContainer_0_BOARD_InitPeripherals 6
...
#define LPUART6_RX_PIN          15u
#define LPUART6_RX_PORT         PTA_L_HALF
#define LPUART6_TX_PIN          0u
#define LPUART6_TX_PORT         PTA_H_HALF
