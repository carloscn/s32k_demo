...
/* Uncomment MBEDTLS_USE_NXP_HSE_HMAC_HASH_384_512 to enable support for HMAC with MD5, SHA384  & SHA512
...
#define MBEDTLS_USE_NXP_HSE_HMAC_HASH_384_512
#endif

#if !((HSE_PLATFORM == HSE_S32K3X1)||(HSE_PLATFORM == HSE_S32K3X2)||(HSE_PLATFORM == HSE_S32K3X4)||(HSE_PLATFORM == HSE_S32K3X6)||(HSE_PLATFORM == HSE_S32K358)||(HSE_PLATFORM == HSE_S32G2XX)||(HSE_PLATFORM == HSE_S32G3XX))
#define MBEDTLS_MD5_ALT
#endif

#ifdef MBEDTLS_USE_NXP_HSE_HMAC_HASH_384_512
...
#else
#define MBEDTLS_TIMING_ALT                      //For timing purpose
//#define MBEDTLS_AES_ALT
//#define MBEDTLS_ARC4_ALT
//#define MBEDTLS_ARIA_ALT
//#define MBEDTLS_BLOWFISH_ALT
...
#if !((HSE_PLATFORM == HSE_S32K3X1)||(HSE_PLATFORM == HSE_S32K3X2)||(HSE_PLATFORM == HSE_S32K3X4)||(HSE_PLATFORM == HSE_S32K3X6)||(HSE_PLATFORM == HSE_S32K358))
#define MBEDTLS_ECP_DP_SECP521R1_ENABLED //Curve SECP521R1 supported for new release of HSE_B Firmware
 ...
 *
 * \note Debugging level is optional for devices except CPU_SAF8544.
 *  So It can be disabled when report is being generated from serial logs.
 */
...
#else
//#define MBEDTLS_PSA_ITS_FILE_C                             testing only
#endif
 ...
 *
 */
#define MBEDTLS_SSL_DTLS_MAX_BUFFERING             2048

//#define MBEDTLS_SSL_DEFAULT_TICKET_LIFETIME     86400 /**< Lifetime of session tickets (if enabled) */
#ifndef MBEDTLS_PSK_MAX_LEN
#define MBEDTLS_PSK_MAX_LEN               			 16 /**< Max size of TLS pre-shared keys, in bytes (default 256 bits) */
#endif//MBEDTLS_PSK_MAX_LEN
//#define MBEDTLS_SSL_COOKIE_TIMEOUT        		 60 /**< Default expiration delay of DTLS cookies, in seconds if HAVE_TIME, or in number of cookies issued */

#if defined (MBEDTLS_USE_NXP_HSE_CRYPTO)
#define DH_PARAM_LEN                        1024 //DH PARAM supported lengths 1024, 2048, 3072, 4096
#endif
...
#define MBEDTLS_AESNI_C                              //Newly added
#define MBEDTLS_ARC4_C
#define MBEDTLS_CHACHA20_C
#define MBEDTLS_CHACHAPOLY_C
#define MBEDTLS_CAMELLIA_C
