...
#ifndef NXP_HSE_CONFIG_H
#define NXP_HSE_CONFIG_H
...
/**
* \def MBEDTLS_USE_NXP_HSE_CRYPTO
*
* Uncomment this line if you want to use NXP HSE Crypto Implementation
* This will enable following macros:
* - MBEDTLS_AES_ALT
* - MBEDTLS_CCM_ALT
* - MBEDTLS_CMAC_ALT
* - MBEDTLS_GCM_ALT
...
* - MBEDTLS_SHA512_ALT
*/
#define MBEDTLS_USE_NXP_HSE_CRYPTO
#define MBEDTLS_USE_NXP_HSE_TRUSTED_KEYSTORE
...
#if (!(defined(CPU_S32G2XX) || defined(CPU_S32K358) || defined(CPU_S32K396) || defined(CPU_S32K388) || defined(CPU_S32K389)))
...
#define MBEDTLS_USE_NXP_HSE_PKCS21_VERIFY_WORKAROUND
#if !defined (S32N55)
...
/* Uncomment MBEDTLS_HMAC_ALT macro to HSE HMAC implementation */
#define MBEDTLS_HMAC_ALT
/* Work around for : HMAC support for large keysize */
#define MBEDTLS_USE_NXP_HSE_HMAC_LARGE_KEYSIZE_WORKAROUND
/* Uncomment MBEDTLS_USE_NXP_HSE_HASH_MD5_HMAC_HASH_384_512 to enable support for HMAC with MD5, SHA384  & SHA512
 * This macro should be disabled for S32K3XX HSE firmware (Firmware does not support)
 * */
#if !((HSE_PLATFORM == HSE_S32K3X1)||(HSE_PLATFORM == HSE_S32K3X2)||(HSE_PLATFORM == HSE_S32K3X4)||(HSE_PLATFORM == HSE_S32K3X6)||(HSE_PLATFORM == HSE_S32K358)||(HSE_PLATFORM == HSE_S32K388) || (HSE_PLATFORM == HSE_S32K389))
#define MBEDTLS_USE_NXP_HSE_HASH_MD5_HMAC_HASH_384_512
#endif
#if !((HSE_PLATFORM == HSE_S32K3X1)||(HSE_PLATFORM == HSE_S32K3X2)||(HSE_PLATFORM == HSE_S32K3X4)||(HSE_PLATFORM == HSE_S32K3X6)||(HSE_PLATFORM == HSE_S32K358)||(HSE_PLATFORM == HSE_S32G2XX)||(HSE_PLATFORM == HSE_S32G3XX) ||(HSE_PLATFORM == HSE_S32K388) || (HSE_PLATFORM == HSE_S32K389) ||(HSE_PLATFORM == HSE_S32N5XX))
#define MBEDTLS_MD5_ALT
#endif
#if !defined(S32N55)
#define MBEDTLS_RNG_DRG3
#define MBEDTLS_RNG_DRG4

#define DRG3	0
#define DRG4	1
#endif
#define MBEDTLS_RNG_PTG3
#define PTG3	2
/* Uncomment any one of the below to be used as alternate hardware entropy source */
#if defined(MBEDTLS_RNG_DRG3)
//#define MBEDTLS_USE_NXP_HSE_HW_ENTROPY_SRC	DRG3
#endif
#if defined(MBEDTLS_RNG_DRG4)
//#define MBEDTLS_USE_NXP_HSE_HW_ENTROPY_SRC	DRG4
#endif
#if defined(MBEDTLS_RNG_PTG3)
#define MBEDTLS_USE_NXP_HSE_HW_ENTROPY_SRC	PTG3
#endif
 ...
 */
#if !defined(S32G3XX) || defined(BENCHMARK)
/* Current AES-XTS has library issue for S32G3XX device,
   so AES-XTS support is disabled for MbedTLS Integration with HSE.
   note: Please remove
   line #if !defined(S32G3XX) || defined(BENCHMARK) and respective #endif line */
#if defined (MBEDTLS_USE_NXP_HSE_CRYPTO)
 ...
 *
 */
#if (!(defined(CPU_S32G2XX) || defined(CPU_S32K358) || defined(CPU_S32K396) || defined(CPU_S32K388) || defined(CPU_S32K389) || defined(CPU_S32K312)))
 ...
 *
 */
/* CPU_S32K312 added to this exclusion list: classic DH needs
 * HSE_SPT_CLASSIC_DH (hse_b_config.h), which reflects actual HSE firmware
 * capability and isn't confirmed for this chip's HSE FW build - same
 * reasoning NXP already applied to the other chips excluded here. */
#if (!(defined(CPU_S32G2XX) || defined(CPU_S32K358) || defined(CPU_S32K396) || defined(CPU_S32K388) || defined(CPU_S32K389) || defined(CPU_S32K312)))
 ...
 *            it, and considering stronger message digests instead.
 *
 * \note MD5 support is not provided in this package
 */
#if !((HSE_PLATFORM == HSE_S32K3X1)||(HSE_PLATFORM == HSE_S32K3X2)||(HSE_PLATFORM == HSE_S32K3X4)||(HSE_PLATFORM == HSE_S32K3X6)||(HSE_PLATFORM == HSE_S32K358)||(HSE_PLATFORM == HSE_S32G3XX)||(HSE_PLATFORM == HSE_S32G2XX) || (HSE_PLATFORM == HSE_S32K388) || (HSE_PLATFORM ==  HSE_S32N55X) || (HSE_PLATFORM == HSE_S32K389))
 ...
 *
 */
#if !((HSE_PLATFORM == HSE_S32K3X1)||(HSE_PLATFORM == HSE_S32K3X2)||(HSE_PLATFORM == HSE_S32K3X4)||(HSE_PLATFORM == HSE_S32K3X6)||(HSE_PLATFORM == HSE_S32K358))
