                                    ...
                                    void *p_ctx )
{
     ...
     */
    crt->pk_raw.p = p;
	/* TODO: RKG: Modification to start here for authenticated key load */
...
#if defined (MBEDTLS_USE_NXP_HSE_X509)
//	crt->ctx_nxp_hse_x509_crt.trustedkeyhandle = nxp_hse_x509_crt_trusted_keyhandle(crt, ); 
#endif /* MBEDTLS_USE_NXP_HSE_X509 */
                ...
                mbedtls_x509_crt_restart_ctx *rs_ctx )
{
    ...
    while( 1 ) {
        ...
        {
        	/* TODO: RKG:Get the Key Handle from TrustCA and add it to child for authenticated key load */
            return( 0 );
        }
