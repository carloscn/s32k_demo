...
*   @file    	certs.c
*
*   @brief   	select server certificate , ca certificate and server key in PEM and DER format
*        		as per cipher suite.
*
...
/* BEGIN FILE binary macro TEST_DH_PARAM_1024_PEM  */

#define TEST_DH_PARAM_1024_PEM 												\
	"-----BEGIN DH PARAMETERS-----\r\n" 									\
	"MIGHAoGBAOhJ1SVQHrojuTAfWCUKvBWPuujAnzGMYDKias2KsWvRgxVjouEbFCNp\r\n" 	\
	"bIHo91mD7RIBMcyKVwYS/JK5Op58Es4Iazo7cN6TeJzqwyXl3dzBMr/zSxIe10q+\r\n" 	\
	"OQmTJhDCpXDfIowSnT3T9GzkBXW/UvDr6MVCYieOeQqn7pUGf37zAgEF\r\n" 			\
	"-----END DH PARAMETERS-----\r\n"

/* END FILE */

/* BEGIN FILE binary macro TEST_DH_PARAM_2048_PEM  */
#define TEST_DH_PARAM_2048_PEM 												\
	"-----BEGIN DH PARAMETERS-----\r\n" 									\
	"MIIBCAKCAQEA6K3uPTrOzo8ABHv4o5Z/Rjai2jS8q5OGyUWoFlZGkGu/DFwvhW+3\r\n"	\
	"y4RyFBB4L+0aKWVzroH57LurbDA5iErjchqIKDz/D2nRObug5zmUmB6QeTRhG6hc\r\n"	\
	"F/43964lsejVAeX0yO6CARyijXXGjhwRxJlfFdAn4i1btceml+dIIrpXgK1CuPNk\r\n"	\
	"ouGPymd92FMJp7tnDcmLkarUnemOj74wUlV0mpf7ETRWWXM1wLHfvMi6ztQi/kSx\r\n"	\
	"qxrtSUvaefXCr8WFHOVD9cqoxqWc59mAPmhUONIenEDD+zhhQ9GMKzViK2JABuBt\r\n"	\
	"hPvJbdzz04k11vTrSWjb1WciSFjMJhmpOwIBBQ==\r\n"							\
	"-----END DH PARAMETERS-----\r\n"
/* END FILE */

/* BEGIN FILE binary macro TEST_DH_PARAM_3072_PEM  */
#define TEST_DH_PARAM_3072_PEM 												\
	"-----BEGIN DH PARAMETERS-----\r\n" 									\
	"MIIBiAKCAYEAi3xZBt+vQtmEjzi22o1ysPyQwcWREg4X9k1ABxVfTNbievRK79FQ\r\n"	\
	"dptd+eDgoLel6mkkfjzfJcRCO6JX0qWYbeGpqQb3PGlKpbHQboTH1Ct6A1vtE/+E\r\n"	\
	"40s6GMxyzvlLzXM1gG2+7LEhwTPVtXdZH/3dOJehfqwyqsTQTeUdQkw0V1N3tmqA\r\n"	\
	"YgMNDkoYEbUGL+TWRtdV5kODs4t+r0pOspaZvu6ZeiqSFr+sxVRrGe+7d4/rM41A\r\n"	\
	"+pUSyGzxkn0mkdv9+0bSvXCSeRGHxhHe1gsOayxUXTv51mFmTesCgiDoOPlxrUwF\r\n"	\
	"CCdPIzamlLXhOpCSJ+ummfEHj/CAo5B6O2bW3RcBaFALr0C9b0AjEFzV0fpSn93m\r\n"	\
	"01HhVpviWJwRY5I5S+VfCnJclO34q+SWdEU7xi65tygXHfLcmSqjX6MajvUr9d8+\r\n"	\
	"XpR/dJaqfJTrnSppJ4mALV/qGOQTd2tbfOoBspQjqzQEEFNnsMQY18jiIPMfMxnZ\r\n"	\
	"UmMYi0yfLy1nAgEF\r\n"													\
	"-----END DH PARAMETERS-----\r\n"
/* END FILE */

/* BEGIN FILE binary macro TEST_DH_PARAM_3072_PEM  */
#define TEST_DH_PARAM_4096_PEM 												\
	"-----BEGIN DH PARAMETERS-----\r\n" 									\
	"MIICCAKCAgEAufWKNnFCFML6IFwlthmlumWGGtsTPYkh6FWLgFutZnRj1A/42DW6\r\n"	\
	"REmJwxbfY1MfDr0hhlm2c+054SLuZjzrR+EhytfD7rTVKDu9EDU2zMqOORIeZJRH\r\n"	\
	"WdFJ2O5Y61HF5hvT0CSIcVIzhRrzFXh+/tkXXfNRsL5L1JGCZ8LuMALXfyrhTFBa\r\n"	\
	"+2JrpgzYIGeiVI/er1M4XssFhKhAzyXFNNAXSSuvplE8ReqHMnVLJlc8QiFJQbO4\r\n"	\
	"sJk6RzgIVbXvKjkWTYgt29yF2AkXruNpWm3OQ5aYjs76ml+imvZtUMTRuARQR0I1\r\n"	\
	"WR0bKyB0iLHPiqda3GAhlocBbQdnF4XG+XKN2Jq36GrWISMifSzFESftVyyAx1fX\r\n"	\
	"LIh4HtNwX9PZaCWucHg8HVciUoGDIARjpyhmsaKrXlgeGV7jg0w3uWOkZEg0YhHv\r\n"	\
	"+SGyrrwMzdxT3gJ78hN1hQ1TLeLVYeh2iZiedQfIojXutjnlKlGXnZD+6tyBgBt2\r\n"	\
	"pZmag3eDfm89lkH7gryBTz4q5eptraUKnKdIioTs8wUEci3YuT6lwa/qJHlVAc4N\r\n"	\
	"6Yp62rWUiV+law+ozFPtS5sj7f3WWm9oBOVYcQKaD4ChEoyMHDL8PJohh6Yo66cl\r\n"	\
	"aiUv4KwW1k35LNOszjtn/56jFi5TBrbLiwYRM4d/zl+S2QkF8/kUkm8CAQU=\r\n"		\
	"-----END DH PARAMETERS-----\r\n"
/* END FILE */
...
#if 	(DH_PARAM_LEN == 1024U)
const char mbedtls_test_dh_param_pem[] = TEST_DH_PARAM_1024_PEM;
#elif	(DH_PARAM_LEN == 2048U)
const char mbedtls_test_dh_param_pem[] = TEST_DH_PARAM_2048_PEM;
#elif	(DH_PARAM_LEN == 3072U)
const char mbedtls_test_dh_param_pem[] = TEST_DH_PARAM_3072_PEM;
#elif	(DH_PARAM_LEN == 4096U)
const char mbedtls_test_dh_param_pem[] = TEST_DH_PARAM_4096_PEM;
#endif
//const size_t mbedtls_test_dh_param_pem_len = sizeof( mbedtls_test_dh_param_pem );
#endif /* MBEDTLS_DHM_C */
#endif /* MBEDTLS_PEM_PARSE_C */
