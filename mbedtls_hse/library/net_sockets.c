...
#include <string.h>
#if defined(S32N55) || defined(S32K389)
#include "eth_port.h"       /*Due to change in TCP/IP stack this file has been renamed */
#else
#if !defined(S32K389) && !defined(S32K344) && !defined(CPU_S32R47)
#include "gmacif.h"
#endif
#endif
