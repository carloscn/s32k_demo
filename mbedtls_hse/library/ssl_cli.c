                                    ...
                                    size_t pms_offset )
{
    ...
    MBEDTLS_SSL_DEBUG_BUF(4, "raw pms secret", p, ssl->handshake->pmslen);
    ...
    MBEDTLS_SSL_DEBUG_BUF(4, "encrypted pms secret", ssl->out_msg + offset + len_bytes, *olen);
...
#else
    return (nxp_hse_ssl_write_encrypted_pms(ssl,
            offset, olen, pms_offset));
#endif
